                 ...
                 <form method="POST" action="{{ route('login') }}" autocomplete="off" class="sign-in-form">
                   @csrf
                             ...
                             <div class="heading">
                               ...
                               <a href="#" class="toggle">Creer un compte</a>
                             </div>
...
<p class="text">
 ...
 <a href="{{ route('password.request') }}">Mot de passe oublier?</a>
                   ...
                   <div class="social-links">
                    ...
                    <a href="{{ route('login.google')}}" class="social-link">
                        <img src="{{ asset('images/google.png') }}" alt="Google" />
                    </a>
                    <a href="{{ route('login.facebook')}}" class="social-link">
                        <img src="{{ asset('images/facebook.png') }}" alt="Facebook" />
                    </a>
                    <a href="{{ route('login.github')}}" class="social-link">
